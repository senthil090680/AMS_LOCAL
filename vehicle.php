...
//
	...
	if($edit_id == '') {
		...
		$fgmembersite->RedirectToURL("view_vehicle.php?success=create");
		echo "&nbsp;";
	} elseif($edit_id != '') {
		if(!mysql_query('INSERT INTO vehicle SET vehicle_regno="'.$vregno.'",vehichle_reg_date="'.$vdate.'",vehicle_comp_id="'.$comp_id.'",vehicle_company_name="'.$company_name.'",insurance_number="'.$insurance_number.'",insurance_company="'.$insurance_company.'",insurance_date="'.$insurance_date.'",currency="'.$currency.'",insurance_amount="'.$insurance_amount.'",insurance_duedate="'.$insurance_duedate.'",tax_number="'.$tax_number.'",tax_authority="'.$tax_authority.'",tax_date="'.$tax_date.'",tax_currency="'.$tax_currency.'",tax_amount="'.$tax_amount.'",tax_renewal_date="'.$tax_renewal_date.'",fitness_certificate_no="'.$fit_certificate_no.'",fit_date="'.$fit_date.'",next_inspection_date="'.$next_inspection_date.'",certification_currency="'.$certification_currency.'",fitness_certification_cost="'.$certification_cost.'",pollution_certificate_no="'.$pollution_certificate_no.'",pollution_certificate_date="'.$pollution_certificate_date.'",pollution_inspection_date="'.$pollution_inspection_date.'",pollution_currency="'.$pollution_currency.'",pollution_certificate_cost="'.$pollution_certificate_cost.'",make="'.$make.'",model="'.$model.'",year="'.$year.'",model_currency="'.$model_currency.'",model_cost="'.$model_cost.'",maintain_currency="'.$maintain_currency.'",total_maintain_cost="'.$total_maintain_cost.'",cost_month="'.$cost_month.'",total_fuel_cost="'.$total_fuel_cost.'",cost_month_fuel="'.$cost_month_fuel.'",car_reg_attach="'.$car_reg_attach.'",insurance_attach="'.$insurance_attach.'",tax_attach="'.$tax_attach.'",pollution_attach="'.$pollution_attach.'",fitness_attach="'.$fitness_attach.'",others_attach="'.$others_attach.'",created_by="'.$user_id.'"')) {
			die('Error: ' . mysql_error());
		...
		<?php
		$fgmembersite->RedirectToURL("edit_vehicle.php?id=$id&secpage=1");
		echo "&nbsp;";
	}
}
?>
  ...
  <td>
   <table>
	<tr height="30">
		 ...
		 <td><input type='text' name='vdate' id='vdate' tabindex="2" size="10" value="<?php echo date('d-m-Y'); ?>" class="datepicker textbox"/></td>
	</tr>
    ...
    <td><input type='text' name='model_cost' id='model_cost' tabindex="8" style="text-align:right;" size="20" autocomplete="off" class="textbox"/></td>
    </tr>   
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
	...
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><input type='text' name='insurance_number' id='insurance_number' tabindex="9" size="20" autocomplete="off" class="textbox" /></td>
    </tr>
	...
	<tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type="text" id="insurance_date" name="insurance_date" tabindex="13" value="<?php echo date('d-m-Y'); ?>" size="10" autocomplete="off" class="datepicker areatext" /></td>
	</tr>
   </table>
   </td>
 </tr>
 ...
 <tr>
  ...
  <table>
	<tr height="30">
     ...
     <!-- <input type='text' name='insurance_company' id='insurance_company' tabindex="9" size="46" autocomplete="off" class="textbox" />--></td>
	</tr>
     
	<tr height="30">
    <td width="120">Premium Amt*</td>
    <td><input type='text' name='insurance_amount' id='insurance_amount' tabindex="12" style="text-align:right;" size="20" autocomplete="off" class="textbox"/></td>
    </tr>    	
    <tr height="30">
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
    ...
    <td width="120">Number</td>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><input type='text' name='tax_number' id='tax_number' size="20" autocomplete="off" tabindex="15" class="textbox"/></td>
    </tr>
	...
	<tr height="30">
     <td width="120">Date</td>
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type="text" id="tax_date" name="tax_date" value="<?php echo date('d-m-Y'); ?>" size="10" autocomplete="off" tabindex="19" class="datepicker areatext" /></td>
	</tr>
   </table>
   </td>
 </tr>
 ...
 <tr>
  ...
  <table>
	<tr height="30">
     ...
     <td><input type='text' name='tax_authority' id='tax_authority' tabindex="16" size="20" autocomplete="off" class="textbox"/></td>
	</tr>
     
	<tr height="30">
    <td width="120">Amount</td>
    <td><input type='text' name='tax_amount' id='tax_amount' style="text-align:right;" size="20" autocomplete="off" tabindex="18" class="textbox"/></td>
    </tr>    	
    <tr height="30">
    <td width="120">Renewal Date</td>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
    ...
    <td width="120">Number</td>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><input type='text' name='fit_certificate_no' id='fit_certificate_no' size="20" autocomplete="off" tabindex="1" class="textbox"/></td>
    </tr>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
	<tr height="30">
     <td width="120" nowrap="nowrap">Date</td>
     <td><input type='text' name='fit_date' id='fit_date' value="<?php echo date('d-m-Y'); ?>" size="10" autocomplete="off" tabindex="2" class="datepicker textbox"/></td>
	</tr>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
    ...
    <td width="120">Number</td>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><input type='text' name='pollution_certificate_no' id='pollution_certificate_no' size="20" autocomplete="off" tabindex="6" class="textbox"/></td>
    </tr>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
	<tr height="30">
     <td width="120" nowrap="nowrap">Date</td>
     <td><input type='text' name='pollution_certificate_date' id='pollution_certificate_date' value="<?php echo date('d-m-Y'); ?>" size="10" autocomplete="off" tabindex="7" class="datepicker textbox"/></td>
	</tr>
     
	<tr height="30">
    <td width="120">Cost</td>
    <td><input type='text' name='pollution_certificate_cost' id='pollution_certificate_cost' style="text-align:right;" size="20" autocomplete="off" tabindex="9" class="textbox"/></td>
    </tr>    	    
      </table>
       </td>
     </tr>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
	...
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><input type='file' name='car_reg_attach' id='car_reg_attach' tabindex="11" class="textbox"/></td>
    </tr>
	...
	<tr height="30">
		...
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<!-- <td><img width="15px" height="15px" src="images/currency.gif"></td> -->
		<td><input type='file' name='tax_attach' id='tax_attach' tabindex="13" class="textbox"/></td>
	</tr>

	<tr height="30">
     <td width="120">Fitness</td>
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type='file' name='fitness_attach' id='fitness_attach' tabindex="15" class="textbox"/></td>
	</tr>
   </table>
   </td>
 </tr>
 ...
 <tr>
  ...
  <table>
	<tr height="30">
     ...
     <td><input type='file' name='insurance_attach' id='insurance_attach' tabindex="12" class="textbox"/></td>
	</tr>
     
	<tr height="30">
    <td width="120">Pollution</td>
    <td><input type='file' name='pollution_attach' id='pollution_attach' tabindex="14" class="textbox"/></td>
    </tr>
    
    <tr height="30">
    <td width="120">Others</td>
    <td><input type='file' name='others_attach' id='others_attach' tabindex="16" class="textbox"/></td>
    </tr>    	    
      </table>
       </td>
     </tr>
