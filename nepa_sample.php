 ...
 <tr>
  ...
  <table>
	...
	<tr height="30">
		...
		<td><input type='text' name='add_currency' id='add_currency' value="<?php echo $row['name']; ?>" size="4" tabindex="4" readonly class="textbox"/></td>
	</tr>

	<tr height="30">
     <td width="120">Date</td>
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type='text' name='mdate' id='mdate' readonly style="width:70px;" value="<?php echo date('d-m-Y'); ?>" class="datepicker textbox"/></td>
	</tr>
  ...
  <td>
   <table>
	<tr height="30">
     ...
     <td><input type='text' name='mnumber' id='mnumber' size="12" autocomplete="off"class="textbox"/></td>
	</tr>

	<tr height="30">
		 <td width="120" nowrap="nowrap">Amount Paid*</td>
		 <td><input type='text' name='amount' id='amount' size="12" autocomplete="off" class="textbox"/></td>
	</tr>
