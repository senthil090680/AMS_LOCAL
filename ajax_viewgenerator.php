...
<div class="con2">
	...
	<tr>
		...
		<td><a href="edit_generator.php?id=<?php echo $fetch['id'];?>"><img src="images/user_edit.png" alt="" title="" width="11" height="11"/></a></td>
		<td><a href="view_generator.php?delete_id=<?php echo $fetch['id'];?>&delete=1"><img src="images/trash.png" alt="" title="" width="11" height="11" onclick="return show_confirm('<?php echo $fgmembersite->upperstate($fetch['description']); ?>');"/></a></td>
	</tr>
	<?php $c++; $cc++; $slno++; }		 
