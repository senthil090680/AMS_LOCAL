...
<div id="errormsg" class="mydiv"><h3 align="center" class="myalign"><?php echo $fgmembersite->GetErrorMessage(); ?></h3><a href="<?php echo $_SERVER['PHP_SELF']; ?>"><button id="closebutton">Close</button></a></div>
<?php }?>
  <div class="clearfix"></div>   
