...
<div class="mcf"></div>
       <div id="colviewajaxid">
			...
			<tr>				
				...
				<td>
				<a href="view_driver.php?delete_id=<?php echo $fetch['id'];?>&delete=1"><img src="images/trash.png" alt="" title="" width="11" height="11" onclick="return show_confirm('<?php echo $fetch['driver_code']; ?>');"/></a>
				</td>
			</tr>
			<?php $c++; $cc++; $slno++; }		 
