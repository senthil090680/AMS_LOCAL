...
function colviewajax(page,params){   // For pagination and sorting of the Collection Deposited view page
	...
	$.ajax({
		url : "ajax_view_vehicle_assignment.php",
		type: "get",
		dataType: "text",
...
if(isset($_GET['delete_id']) && intval($_GET['delete_id'])) {
	...
	$fgmembersite->RedirectToURL("view_vehicle_assignment.php?success=delete");
	// 
	//echo "hi";
	}
}
...
<div class="mcf"></div>
<div><h2 align="center">VEHICLE ASSIGNMENT</h2></div> 

<div id="containerprforcd">

<span style="float:left;"><input type="button" name="kdproduct" value="Add Vehicle Assignment" class="buttonsbig1" onclick="window.location='vehicle_assignment.php'"></span><span style="float:right;"><input type="button" name="kdproduct" value="Close" class="buttons" onclick="window.location='ams_temp.php?id=3'"></span>

<div class="clearfix"></div>

<div id="search">
        <input type="text" name="searchname" id="searchname" value="<?php echo $_REQUEST['searchname']; ?>" autocomplete='off' placeholder='Search By Registration Number'/>
